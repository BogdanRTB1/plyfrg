    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex max-h-[100dvh] min-h-[100dvh] w-full max-w-[100vw] items-stretch overscroll-none md:items-center justify-center bg-black p-0 backdrop-blur-none md:bg-black/80 md:backdrop-blur-sm md:p-4 overflow-hidden">
            <motion.div
                ...
                className={`${TOMATOES_CONFIG.theme.background} rounded-none md:rounded-2xl w-full max-w-5xl border border-white/10 shadow-2xl overflow-hidden flex flex-col-reverse md:flex-row h-[100dvh] max-h-[100dvh] md:h-[700px] md:max-h-[90vh] min-h-0`}
            >
                {/* ADVANCED BETTING MENU */}
                <div className={`w-full md:w-80 max-h-[min(30vh,240px)] md:max-h-none shrink-0 overflow-y-auto overscroll-contain ${TOMATOES_CONFIG.theme.panelBg} p-3 flex flex-col gap-2 md:p-6 md:gap-4 border-r border-black/50 z-20`}>
