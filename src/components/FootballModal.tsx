        ...
        <div className="fixed inset-0 z-[100] flex max-h-[100dvh] min-h-[100dvh] w-full max-w-[100vw] items-stretch overscroll-none md:items-center justify-center bg-black p-0 backdrop-blur-none md:bg-black/80 md:backdrop-blur-sm md:p-4 overflow-hidden">
            ...
            >
                ...
                <div className={`flex-1 relative ${FOOTBALL_CONFIG.theme.gameBg} bg-cover bg-center p-2 sm:p-6 flex flex-col justify-center items-center overflow-hidden shadow-inner`}>
                    <button type="button" onClick={onClose} className="absolute right-2 top-2 z-[80] flex h-10 w-10 items-center justify-center rounded-xl border border-emerald-500/20 bg-black/50 text-emerald-100 backdrop-blur-sm md:hidden active:bg-white/10" aria-label="Close game">
                        <X className="h-5 w-5" />
                    </button>
